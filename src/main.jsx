...
import { Dashboard, Home, Login, Product, Category, Register, ForgetPassword, ChangePassword, Cart, Order, History, Setting, PrivacyPolicy, TermsConditions, RefundPolicy } from './components/index.js';
